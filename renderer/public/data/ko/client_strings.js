...
export default {
  ...
  CHART_AREAS: {
    '심연의 평야': { type: 'AbyssalPlain', discriminator: 'chart_sandy_seabed' },
    정박장: { type: 'Anchorfield', discriminator: 'chart_sandy_seabed' },
    '염수왕의 영토': { type: 'BrineKingsDomain', discriminator: 'chart_coral_reef' },
    '조개투성이 선반': { type: 'ClamInfestedShelf', discriminator: 'chart_coral_reef' },
    '잠수 모래톱': { type: 'DivingShoals', discriminator: 'chart_coral_reef' },
    '위태한 지하': { type: 'HazardousDepths', discriminator: 'chart_sandy_seabed' },
    '감염된 잠수구': { type: 'InfestedBathyspheres', discriminator: 'chart_sandy_seabed' },
    '키샤라의 안식처': { type: 'KisharasRest', discriminator: 'chart_sandy_seabed' },
    '잃어버린 폐허': { type: 'LostRuins', discriminator: 'chart_coral_forest' },
    '원양 심연': { type: 'PelagicAbyss', discriminator: 'chart_coral_forest' },
    '해저 마루': { type: 'SeafloorRidges', discriminator: 'chart_coral_reef' },
    '바다 기둥': { type: 'SeaPillars', discriminator: 'chart_coral_forest' },
    '가라앉은 토템': { type: 'SunkenTotems', discriminator: 'chart_coral_reef' },
    '바다 밑 숲': { type: 'UnderseaGroves', discriminator: 'chart_coral_forest' }
  },
  ...
  ESSENCE_MODS: ['- 에센스', '에센스'],
  INFAMOUS_MODS: ['- 악명', '악명 높은'],
