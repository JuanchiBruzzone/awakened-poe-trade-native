...
export default {
  ...
  CHART_AREAS: {
    'Abyssal Plain': { type: 'AbyssalPlain', discriminator: 'chart_sandy_seabed' },
    Anchorfield: { type: 'Anchorfield', discriminator: 'chart_sandy_seabed' },
    'Brine King\'s Domain': { type: 'BrineKingsDomain', discriminator: 'chart_coral_reef' },
    'Clam-infested Shelf': { type: 'ClamInfestedShelf', discriminator: 'chart_coral_reef' },
    'Diving Shoals': { type: 'DivingShoals', discriminator: 'chart_coral_reef' },
    'Hazardous Depths': { type: 'HazardousDepths', discriminator: 'chart_sandy_seabed' },
    'Infested Bathyspheres': { type: 'InfestedBathyspheres', discriminator: 'chart_sandy_seabed' },
    'Kishara\'s Rest': { type: 'KisharasRest', discriminator: 'chart_sandy_seabed' },
    'Lost Ruins': { type: 'LostRuins', discriminator: 'chart_coral_forest' },
    'Pelagic Abyss': { type: 'PelagicAbyss', discriminator: 'chart_coral_forest' },
    'Seafloor Ridges': { type: 'SeafloorRidges', discriminator: 'chart_coral_reef' },
    'Sea Pillars': { type: 'SeaPillars', discriminator: 'chart_coral_forest' },
    'Sunken Totems': { type: 'SunkenTotems', discriminator: 'chart_coral_reef' },
    'Undersea Groves': { type: 'UnderseaGroves', discriminator: 'chart_coral_forest' }
  },
