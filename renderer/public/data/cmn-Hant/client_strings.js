...
export default {
  ...
  CHART_SULPHUR: '亡者硫酸: ',
  CHART_AREAS: {
    深海平原: { type: 'AbyssalPlain', discriminator: 'chart_sandy_seabed' },
    定錨點: { type: 'Anchorfield', discriminator: 'chart_sandy_seabed' },
    海洋王的領域: { type: 'BrineKingsDomain', discriminator: 'chart_coral_reef' },
    蛤蜊之架: { type: 'ClamInfestedShelf', discriminator: 'chart_coral_reef' },
    潛水沙洲: { type: 'DivingShoals', discriminator: 'chart_coral_reef' },
    危機海淵: { type: 'HazardousDepths', discriminator: 'chart_sandy_seabed' },
    感染潛水球: { type: 'InfestedBathyspheres', discriminator: 'chart_sandy_seabed' },
    奇夏拉安眠地: { type: 'KisharasRest', discriminator: 'chart_sandy_seabed' },
    失落遺跡: { type: 'LostRuins', discriminator: 'chart_coral_forest' },
    遠洋深淵: { type: 'PelagicAbyss', discriminator: 'chart_coral_forest' },
    海底山脊: { type: 'SeafloorRidges', discriminator: 'chart_coral_reef' },
    海洋之柱: { type: 'SeaPillars', discriminator: 'chart_coral_forest' },
    沉沒圖騰: { type: 'SunkenTotems', discriminator: 'chart_coral_reef' },
    海底幽林: { type: 'UnderseaGroves', discriminator: 'chart_coral_forest' }
  },
